...
void main() {
  testWidgets('render animated diagonal snakes', (tester) async {
    ...
    for (var panel = 0; panel < 3; panel++) {
      ...
      final title = TextPainter(
        text: TextSpan(
          text: [
            'EMERALD · DIAGONAL DESCENT',
            'JADE · SLITHERING BODY',
            'COPPER · DARK BOARD',
          ][panel],
